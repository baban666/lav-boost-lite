			...
			'fields' => array(
				...
				array(
					...
					'content' => '<p>'. esc_html__('For customers who need to set up the most popular and effective tools to increase sales simple products in the WooCommerce store in a few clicks. LavBoost - the All in One Sales Increasing Plugin.', 'up-sell-pro').'</p>
                              ...
                              <p>'. esc_html__('Please ask any question via contact form on', 'up-sell-pro').' <a href="'. esc_url('https://codecanyon.net/user/alicethemes')  .'" target="_blank" >'. esc_html__('Website', 'up-sell-pro').'</a> </p>',
				),
				array(
					'type'    => 'heading',
				...
				array(
					...
					'content' => '<div class="up-cards-container">
								...
								<div class="card">
								  <div class="image">
								    <!-- You can add an image here using the <img> element -->
								    <img src="'. esc_url(LAV_BOOST_URL . '/admin/img/lav.jpg')  .'" alt="Curie">
								  </div>
								  <div class="content">
								...
								<div class="card">
								  <div class="image">
								    <!-- You can add an image here using the <img> element -->
								    <img src="'. esc_url(LAV_BOOST_URL . '/admin/img/wellbook.jpg')  .'" alt="Curie">
								  </div>
								  <div class="content">
								    <h2 class="title">'. esc_html__('WellBook','up-sell-pro').'</h2>
								    <p class="description">'. esc_html__('Simple and Fast WordPress Theme For Authors And Writers','up-sell-pro').'</p>
